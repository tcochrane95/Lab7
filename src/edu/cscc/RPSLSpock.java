...
public class RPSLSpock {
     ...
     * when user picks valid option, use ignoreCase to return pick
     */
    ...
    /**
     * randomly generated pick from five options (arrays), break once pick has been matched
    ...
    /**
     *
     * @param c_pick computer generated pick vs
     * @param h_pick human chosen pick
     * @return result is a computer win
     */
